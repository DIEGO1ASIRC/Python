...
print("El primer año tus ahorros serán", round(ahorros_finales, 2), "tu segundo año serán de", round(ahorros_finales2, 2), "tu tercer año serán de", round(ahorros_finales3, 2))
